...
const PostLogin = () => {
  ...
  return (
    <div className="w-full md:w-[38%] h-[100vh] flex justify-center items-end bg-image1 bg-no-repeat bg-origin-border bg-center bg-cover scale-x-[-1]">
      <div className="w-full h-[70vh] bg-white rounded-t-3xl shadow-lg shadow-black scale-x-[-1] flex flex-col justify-start items-center py-2 px-10 gap-6">
        <div className="w-16 h-1 bg-darkgray rounded-full mb-5"></div>
        <svg
          width="207"
          height="168"
          viewBox="0 0 207 168"
        ...
        <h5 className="text-[2rem] font-semibold text-black">
          Login Successful
        </h5>

        <button
          onClick={() => navigate("/tracking")}
          className="w-full bg-orange p-4 rounded-full text-white"
        >
